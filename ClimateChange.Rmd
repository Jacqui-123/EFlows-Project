...
final_pc %>%
  #filter(Watershed == "B") %>%
filter(Station_Number == "07BK007" | Station_Number == "07BE001" | Station_Number == "07CD005") %>%
ggplot(aes(y= Reversals, x = factor(Year), group = Station_Number, colour = Station_Number)) +
  ...
  annotate(geom = "text", x = 14, y = 14, label = "Driftwood River, \n AB", colour = "#56B4E9") +    #07BK007
    annotate(geom = "text", x = 12, y = 45, label = "Clearwater River, \n Fort McMurray", colour = "#999999") + #07CD005
  geom_hline(yintercept = 0, linetype = "dotted") +
 # scale_x_discrete(breaks = seq(1975, 2006, 2)) +
 ylim(-60, 60) +
   theme_classic() +
...
ggplot(aes(y= Reversals, x = factor(Year), group = Station_Number, colour = Station_Number)) +
  geom_line(linewidth = .75, linetype = "F1") +
  annotate(geom = "text", x = 38, y = 73, label = "Athabasca River, \n Athabasca", colour = "#E69F00") + #07BE001
 annotate(geom = "text", x = 44, y = 68, label = "Driftwood River, \n AB", colour = "#56B4E9") +    #07BK007
   annotate(geom = "text", x = 43, y = 25, label = "Clearwater River, \n Fort McMurray", colour = "#999999") + #07CD005
  #geom_hline(yintercept = 0, linetype = "dotted") +
...
ggplot(aes(y= One_Day_Max, x = factor(Year), group = Station_Number, colour = Station_Number)) +
  ...
  annotate(geom = "text", x = 13.5, y = 195, label = "Driftwood River, \n AB", colour = "#56B4E9") +    #07BK007
    annotate(geom = "text", x = 14, y = -30, label = "Clearwater River, \n Fort McMurray", colour = "#999999") + #07CD005
  geom_hline(yintercept = 0, linetype = "dotted") +
 # scale_x_discrete(breaks = seq(1975, 2006, 2)) +
 ylim(-100, 200) +
   theme_classic() +
...
ggplot(aes(y= One_Day_Max, x = factor(Year), group = Station_Number, colour = Station_Number)) +
  geom_line(linewidth = .75, linetype = "F1") +
annotate(geom = "text", x = 42, y = 3000, label = "Athabasca \n River, \n Athabasca", colour = "#E69F00") + #07BE001
annotate(geom = "text", x = 42, y = 500, label = "Driftwood River, \n AB", colour = "#56B4E9") +    #07BK007
annotate(geom = "text", x = 35, y = 500, label = "Clearwater River, \n Fort McMurray", colour = "#999999") + #07CD005
 # geom_hline(yintercept = 0, linetype = "dotted") +
scale_x_discrete(breaks = seq(1974, 2020, 2)) +
 ylim(0, 5000) +
   theme_classic() +
...
ggplot(aes(y= One_Day_Min, x = factor(Year), group = Station_Number, colour = Station_Number)) +
  ...
  annotate(geom = "text", x = 14, y = 205, label = "Driftwood River, \n AB", colour = "#56B4E9") +    #07BK007
    annotate(geom = "text", x = 14, y = -40, label = "Clearwater River, \n Fort McMurray", colour = "#999999") + #07CD005
  geom_hline(yintercept = 0, linetype = "dotted") +
 # scale_x_discrete(breaks = seq(1975, 2006, 2)) +
 ylim(-100, 250) +
   theme_classic() +
...
ggplot(aes(y= One_Day_Min, x = factor(Year), group = Station_Number, colour = Station_Number)) +
  geom_line(linewidth = .75, linetype = "F1") +
  annotate(geom = "text", x = 38, y = 125, label = "Athabasca River, \n Athabasca", colour = "#E69F00") + #07BE001
 annotate(geom = "text", x = 43, y = 19 , label = "Driftwood River, \n AB", colour = "#56B4E9") +    #07BK007
   annotate(geom = "text", x = 43, y = 65, label = "Clearwater River, \n Fort McMurray", colour = "#999999") + #07CD005
  #geom_hline(yintercept = 0, linetype = "dotted") +
scale_x_discrete(breaks = seq(1974, 2020, 2)) +
ylim(0, 150) +
theme_classic() +
