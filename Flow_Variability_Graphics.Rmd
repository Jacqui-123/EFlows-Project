...
#this is incorrect/depreciated now
perc_change <-  ((IHA_output_post_mean - IHA_output_pre_mean)/IHA_output_pre_mean) * 100
```
...
func_output_test <- function(datapre, datapost)
#First get the mean output for the pre-dam IHA outputs
IHA_output_pre_mean <- IHA_output_pre %>%
  summarise(across(October:Reversals, mean)) 
