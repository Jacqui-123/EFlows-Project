...
Variables Calculated: IHA, ice cycle variables, and percent change
...
# Tidy data: Pre climate change stns 1975-2005
```{r}
...
# IHA calculations - Pre climate change stns 
```{r}
...
# Tidy data - Post climate change stns 2006-2023
```{r}
...
#Data prep - Percent change, IHA Variables 
```{r}
#data prep, IHA-pre
...
#Calculate percent change, IHA Variables
```{r}
...
#write.csv(result_MK_IHA, "IHAresult4.csv")
