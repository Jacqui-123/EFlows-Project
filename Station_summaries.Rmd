...
First make a df of all flows for all stations 
```{r}
...
Graph a tile plot, and shade/fill by what percent of the year each station has. 
```{r}
...
test_flows_daily <- tidyhydat::hy_daily_flows(station_number =  c("07AA001", "07AA002", "07AA003", "07AA004", "07AA007", "07AA008", "07AA009", "07AA010", "07AB002", "07AC001", "07AC002"))
...
Make a function to create tile plots 

```{r}

tileplot <- function(data, x, y, fill) {
...
tileplot(test_flows_daily_test, Year, STATION_NUMBER, Number_values )
...
```{r}
#ignore this, was for when looking at number of years, but need to look at how many total days in a year have data
